...
<head>
    ...
    <title><?= ucfirst( basename($_SERVER['PHP_SELF'],'.php')); ?> | ForumKita</title>
    ...
    * {
        font-family: 'Maven Pro', sans_serif;
    }
    </style>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
        <!-- Brand -->
        <a class="navbar-brand" href="#"><i class="fas fa-code fa-lg"></i>&nbsp;&nbsp;ForumKita</a>
