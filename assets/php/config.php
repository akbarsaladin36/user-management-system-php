...
class Database {
    ...
    // Username and Password For PHPMailer
    const USERNAME = 'pembawaharapanpalsu112@gmail.com';
    const PASSWORD = 'kerasukancoding1980@@';

    //Connecting To Database
    private $dsn = "mysql:host=localhost;dbname=user_management_system";
    private $dbuser = "root";
    private $dbpass = "";
