...
?>
        ...
        <div class="col-lg-12">
            <div class="card-deck mt-3 text-light text-center font-weight-bold">
                ...
                <div class="card bg-danger">
                    <div class="card-header">Total Website Hits</div>
                    <div class="card-body">
                        <h1 class="display-4">
    ...
    <script type="text/javascript">
        ...
        //Insert Google Chart for Gender's Percentage
        google.charts.load('current', {'packages':['corechart']});
            ...
            //Insert Google Chart to Verified/Unverified Percentage 
            google.charts.load('current', {'packages':['corechart']});
