...
<head>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.14.0/js/all.min.js" defer>
    </script>
    <script type="text/javascript">
    $(document).ready(function() {

        //Make Admin Navbar Hide and Show
            ...
            <div class="admin-nav p-0">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="admin-feedback.php"
                        class="list-group-item text-light admin-link <?= basename($_SERVER['PHP_SELF'] == 'admin-feedback.php')?"nav-active":""; ?>"><i
                            class="fas fa-comment"></i>&nbsp;&nbsp;Feedback</a>
                    <a href="admin-notification.php"
                        class="list-group-item text-light admin-link <?= basename($_SERVER['PHP_SELF'] == 'admin-notification.php')?"nav-active":""; ?>"><i
                            class="fas fa-bell"></i>&nbsp;&nbsp;Notification&nbsp;<span id="checkNotification"></span></a>
