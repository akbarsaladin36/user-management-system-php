                ...
                <?php if($verified == 'Not Verified!'): ?>
                    <div class="alert alert-danger alert-dismissible text-center mt-2 m-0">
                        <button class="close" type="button" data-dismiss="alert">&times;</button>
                            <strong>Your email is not verified! We've send an email verification to your email. Check and verify your email now!</strong>
                    </div>
                <?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" method="post" id="edit-note-form" class="px-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="title" id="title" class="form-control form-control-lg" placeholder="Edit Title" required>
                        </div>
                        <div class="form-group">
            ...
            $("#editNoteBtn").click(function(e){
                if($("#edit-note-form")[0].checkValidity()){
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            Swal.fire({
                                title: 'Note have been updated successfully!',
                                type: 'success'
                            });
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        Swal.fire({
                            ...
                            type: 'info',
                            html: '<b>Title : </b>'+data.title+'<br><br>Note : </b>'+data.note+'<br><br>Written On : </b>'+data.created_at+'<br><br>Updated On : </b>'+data.updated_at,
